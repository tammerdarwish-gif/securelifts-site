        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="text-4xl font-black tracking-tight md:text-6xl">
              Canyon Ridge 4-Layer Garage Doors
            </h1>
            <p className="mt-6 text-lg leading-8 text-slate-200">
              A premium carriage-house direction for homeowners who want a strong wood-style appearance with more budget control than the heavier 5-layer path.
            </p>
          ...
          <div className="relative h-[360px] overflow-hidden rounded-3xl">
            <Image
              src="/showroom/canyon-ridge/canyon-ridge-4layers.webp"
              alt="Canyon Ridge 4-Layer carriage house garage door option"
              fill
              priority
