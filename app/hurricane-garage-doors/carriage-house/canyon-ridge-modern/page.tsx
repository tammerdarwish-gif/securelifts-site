        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="mb-4 text-sm font-bold uppercase tracking-[0.22em] text-red-400">
              Canyon Ridge Modern Direction
            </p>
            <h1 className="text-4xl font-black tracking-tight md:text-6xl">
              Canyon Ridge Modern Garage Doors
            </h1>
            <p className="mt-6 text-lg leading-8 text-slate-200">
              A premium modern direction for homes that need wood-look warmth, cleaner lines, glass options, and a more architectural garage door appearance.
            </p>
          ...
          <div className="relative h-[360px] overflow-hidden rounded-3xl">
            <Image
              src="/showroom/canyon-ridge/conyon-ridge-modern.webp"
              alt="Canyon Ridge Modern garage door option"
              fill
              priority
